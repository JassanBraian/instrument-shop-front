...
const InstrumModCre = ({ showModCre, setShowModCre }) => {

    const { createInstrument } = useContext(InstrumContext);
            ...
            >
                ...
                <Modal.Footer>
                    <ButtonGroup>
                        ...
                        <Button variant='danger' onClick={() => setShowModCre(false)}>Close</Button>
                    </ButtonGroup>
                </Modal.Footer>
            </Modal>
        </>
